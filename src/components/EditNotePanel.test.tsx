...
describe("EditNotePanel", () => {
  ...
  it("calls updateNote with correct args and fires onSaved", async () => {
    ...
    const note = makeNote({ id: "00000000-0000-0000-0000-000000000005", title: "Old Title", content: "Old content", tags: [] });
    render(<EditNotePanel note={note} onClose={onClose} onSaved={onSaved} />);
    ...
    await waitFor(() => {
      expect(api.updateNote).toHaveBeenCalledWith("00000000-0000-0000-0000-000000000005", "New Title", "Old content", []);
